              ...
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                ...
                >
                  <>
                    ...
                    customers. This policy sets out how if you are a BlockEstate.com
              ...
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                <div className="flex flex-col gap-6 items-start justify-start w-full">
                  ...
                  >
                    <>
                      ...
                      BlockEstate.com user or visitor to our site, we treat your
                ...
                <div className="flex flex-col gap-6 items-start justify-start w-full">
                  ...
                  >
                    ...
                    Visitors to BlockEstate that do not want cookies put on their
                    browsers should configure their browsers to reject cookies
                    before using the BlockEstate website.
                  </Text>
                </div>
                <div className="flex flex-col gap-6 items-start justify-start w-full">
                  <Text
                ...
                <div className="flex flex-col gap-8 items-start justify-start w-full">
                  ...
                  >
                    <>
                      ...
                      https://BlockEstate.com/signup (Registration).
                      <br />
                      <br />
                      ...
                      message or by contacting us at support@BlockEstate.com.
                    </>
                  </Text>
                </div>
                <div className="flex flex-col gap-6 items-start justify-start w-full">
